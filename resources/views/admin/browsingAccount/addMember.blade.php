...
<div class="container-fluid">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-6">
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="email" name="email" placeholder="abc@gmail.com..." class="form-control form-control-line">
                    </div>
                </div>
            </div>
            <div class="col-6">
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="text" name="name" placeholder="your name" class="form-control form-control-line">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-sm-12">
                <button class="btn btn-success">Create New Member</button>
            </div>
        </div>
    </form>
</div>
